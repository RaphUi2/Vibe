      ...
      <div className="max-w-[1300px] mx-auto flex h-full">
        ...
        <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-[100] bg-black/60 backdrop-blur-3xl border-t border-white/10 px-4 py-3 pb-8 flex justify-between items-center shadow-4xl">
          {[
            ...
            { id: 'games', icon: 'M11 4a2 2 0 114 0v1a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-1a2 2 0 100 4h1a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 00-1 1v1a2 2 0 11-4 0v-1a1 1 0 00-1-1H7a1 1 0 01-1-1v-3a1 1 0 00-1-1H4a2 2 0 110-4h1a1 1 0 001-1V7a1 1 0 011-1h3a1 1 0 001-1V4z' },
